...
function Game() {
  ...
  useEffect(() => {
    const checkWinner = () => {
      ...
      // Если все клетки заполнены и победителя нет, это ничья
      if (turnCount === 10 && !winner) {
        setDraw('Ничья!');
      }
    };
    checkWinner();
  }, [cell1, cell2, cell3, cell4, cell5, cell6, cell7, cell8, cell9, turnCount, winner]);
  ...
  return (
    <>
      <div className="game">
        ...
        {draw && <div className="draw-message">Ничья!!</div>}
